...
2. There will be two Task workqueues for the BFD packet processing
    1 ) BFD control packet workqueue and [a.k.a WorkQueue#1]
       These packets are received when the BFD client session is Down (no session is established). The workqueue jobs run with mutual exclusive to "dB" task since its processing has dependency with Db table.
...
## **11. References**
 ...
 1 ) JIRA:
     * [TFF-9](https://jira.tungsten.io/browse/TFF-9)
     * [CEM-16291](https://contrail-jws.atlassian.net/browse/CEM-16291)

 2 ) Test Plan Document: [CEM-16291 BFD Priority Queue Test Plan.xlsx](https://drive.google.com/file/d/1UnS_HRRFuauoHJxUVQGx4J7DwLkb-y9J/view?usp=sharing)

 3 ) BFD RFC: [BFD_RFC5880](https://tools.ietf.org/html/rfc5880)
