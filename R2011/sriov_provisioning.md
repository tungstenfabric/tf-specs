...
-   ### Contrail Config received Virtual Machine Interface(VMI) object of created VM
Contrail Config receives POST request through /virtual-machine-interface. The request contains a VMI object.
-   ### Config retrives Physical Network ID and Segmentation ID from VN
...
-   ### Config retrives SR-IOV Port's corresponding Port object
...
-   ### Config retrives Switch Port information
...
-   ### Config creates a VPG object which refers to placeholder VMI, and Swith Port information
